/**
 * `maskIcon`: This icon represents a masked screen.
 * */
export const maskIcon =
  '<svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M23.8333 13V9.75002C23.8333 4.33335 21.6667 2.16669 16.25 2.16669H9.75C4.33334 2.16669 2.16667 4.33335 2.16667 9.75002V16.25C2.16667 21.6667 4.33334 23.8334 9.75 23.8334H13" stroke="#5150AE" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M22.7067 19.3267L20.9408 19.9225C20.4533 20.085 20.0633 20.4642 19.9008 20.9625L19.305 22.7283C18.7958 24.2558 16.6508 24.2233 16.1742 22.6958L14.17 16.25C13.78 14.9717 14.9608 13.78 16.2283 14.1808L22.685 16.185C24.2017 16.6617 24.2233 18.8175 22.7067 19.3267Z" stroke="#5150AE" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>';
/**
 * `stopMaskIcon`: This icon represents a stopped mask
 * */
export const stopMaskIcon =
